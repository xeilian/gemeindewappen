"""
Django settings for gemeindewappen project.
...
SECRET_KEY = 'django-insecure-uvkz5c)^t-5xn35-^4(7wil59k8&r1w!b4nmb1fv=en9b*!8!)'
...
ROOT_URLCONF = 'gemeindewappen_project.urls'
...
WSGI_APPLICATION = 'gemeindewappen_project.wsgi.application'
